    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={[styles.detailsContainer, { backgroundColor: theme.surface }]}>
        ...
        <Text style={styles.delieverd}>
          Delievered By : <Text style={{fontWeight:'400',color:"black"}}>Umair Khan</Text>
        </Text>
        <Text style={styles.delieverd}>
          Received By : <Text style={{fontWeight:'400',color:"black"}}>Umair Khan</Text>
        </Text>
          </View>
      </View>
    </View>
...
const styles = StyleSheet.create({
  ...
  delieverd:{fontWeight:'bold',fontSize:11,color:"black"},
